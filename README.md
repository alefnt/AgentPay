...
**How it works**: Both networks use HTLC (Hash Time-Locked Contracts). The Cch module locks funds on both sides with the **same hash** — either both payments complete, or both refund. No trust needed.
